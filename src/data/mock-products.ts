...
export const categories: Category[] = [
  { id: "1", name: "Smartphones",       slug: "smartphones", icon: "Smartphone",  productCount: 6  },
  { id: "2", name: "Laptops / PCs",     slug: "laptops",     icon: "Laptop",      productCount: 6  },
  { id: "3", name: "Audio",             slug: "audio",       icon: "Headphones",  productCount: 5  },
  { id: "4", name: "Gaming",            slug: "gaming",      icon: "Gamepad2",    productCount: 5  },
  { id: "5", name: "Tablets",           slug: "tablets",     icon: "Tablet",      productCount: 4  },
  { id: "6", name: "Accesorios",        slug: "accesorios",  icon: "Package",     productCount: 4  },
]
...
export const brands: Brand[] = [
  ...
  { id: "5", name: "MSI",       productCount:  2 },
  { id: "6", name: "Logitech",  productCount:  3 },
]
