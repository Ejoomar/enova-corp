    ...
    <div className="mx-auto max-w-[1440px] px-6 lg:px-10 py-20">
      ...
      <div className="max-w-3xl space-y-10">
        {[
          ...
          { title: "4. Garantías",               body: "Los productos adquiridos en ENOVA CORP ® tienen garantía de 6 meses a 1 año según la marca y categoría. Laptops y PCs (Dell, HP, Lenovo): 1 año. Equipos de red, cámaras y accesorios: 6 meses. Las garantías no cubren daños por mal uso." },
